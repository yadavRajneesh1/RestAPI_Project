...
import org.rajneesh.massanger.service.MessageService;
...
public class MessageResources {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Message updateMessage(@PathParam("messageId") long i, Message message)
	{
		message.setId(i);
	...
	{
		return messageService.removeMessages(messageId);
	}
